      ...
      <f7-view id="left-panel-view" navbar-through :dynamic-navbar="true">
        ...
        <f7-pages>
          <f7-page>
            ...
            <f7-block-title>
              <f7-list>
              <f7-list-item link="/profile/" title="Pham"   link-view="#main-view" link-close-panel align="center"> <img alt="User Pic" src="https://x1.xingassets.com/assets/frontend_minified/img/users/nobody_m.original.jpg" id="profile-image1" class="img-circle img-responsive"> </f7-list-item> 
              </f7-list>
            </f7-block-title>
            <f7-list>
    ...
    <f7-views>
      <f7-view id="main-view" navbar-through :dynamic-navbar="true" main>
        ...
        <f7-navbar v-if="$theme.ios">
          ...
          <f7-nav-center sliding>King's award</f7-nav-center>          
        </f7-navbar>
        <!-- Pages -->
        <f7-pages>
